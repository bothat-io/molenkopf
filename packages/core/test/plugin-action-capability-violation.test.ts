...
test("Action requiring missing capability is blocked", () => {
  const result = resolveActionPermission(
    ...
    { pluginId: "sample-observer-plugin", enabled: true, maxRisk: "yellow", capabilities: ["metadata:read"], actions: [], settings: {}, source: { enabled: "global", maxRisk: "global", capabilities: "global", actions: "global", settings: {} }, blockedReasons: [] }
  );
