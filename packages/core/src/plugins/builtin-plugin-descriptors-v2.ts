...
import { descriptorV2 as obsidianGraphDescriptorV2 } from "../../../plugins/obsidian-graph-plugin/descriptor-v2.ts";
...
export { contextCompressorDescriptorV2, obsidianGraphDescriptorV2, projectGraphDescriptorV2, tokenOptimizerDescriptorV2 };

export const builtinPluginDescriptorsV2: readonly PluginDescriptorV2[] = [
  contextCompressorDescriptorV2,
  obsidianGraphDescriptorV2,
